...
## Project Structure
    ...
    ├── fashionistas_by_mon_35384  # Django project configurations
...
1. Clone this repo and `cd fashionistas_by_mon_35384`
...
2. Clone this repo and `cd fashionistas_by_mon_35384`
